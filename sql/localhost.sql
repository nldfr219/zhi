...
-- 数据库: `board`
--
CREATE DATABASE `board` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `board`;
...
('def', 'board', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(12)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'board', 'users', 'name', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
...
('def', 'shop', 'b2c_ad', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_ad', 'code', 2, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_ad', 'views', 3, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_ad', 'visible', 4, '1', 'YES', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(5)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_ad', 'posttime', 5, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_class', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_class', 'name', 2, '', 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_bin', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_class', 'up_id', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'up_id', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'name', 3, '', 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'descript', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'image', 5, NULL, 'YES', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'price_m', 6, '0', 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'price', 7, '0', 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'state', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_goods', 'date', 9, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'name', 2, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'url', 3, '', 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'image', 4, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'width', 5, '88', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'height', 6, '31', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(6)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'views', 7, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'clicks', 8, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'visible', 9, '1', 'YES', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(5)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_link', 'posttime', 10, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_news', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_news', 'title', 2, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_news', 'content', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_news', 'key_words', 4, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_news', 'date', 5, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_news', 'read_no', 6, '0', 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(5) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'user_id', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'name', 3, '', 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'sex', 4, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'email', 5, '', 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'state', 6, '', 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'city', 7, '', 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'tel', 8, '', 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'address', 9, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'post', 10, '', 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'attrib', 11, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'fee', 12, '0.00', 'NO', 'decimal', NULL, NULL, 16, 2, NULL, NULL, 'decimal(16,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'pay', 13, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'send_out', 14, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'payment', 15, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'date_created', 16, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'cardnumber', 17, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'nameoncard', 18, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'expdate', 19, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_requests', 'orderstatus', 20, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_shopping', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_shopping', 'requests_id', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_shopping', 'user_id', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_shopping', 'goods_id', 4, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_shopping', 'goods_num', 5, '0', 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_shopping', 'date_created', 6, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'u_name', 2, '', 'NO', 'varchar', 16, 16, NULL, NULL, 'latin1', 'latin1_bin', 'varchar(16)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'u_pass', 3, '', 'NO', 'varchar', 16, 16, NULL, NULL, 'latin1', 'latin1_bin', 'varchar(16)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'name', 4, '', 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'sex', 5, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'email', 6, '', 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'state', 7, '', 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'city', 8, '', 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'tel', 9, '', 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'address', 10, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'post', 11, '', 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'attrib', 12, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'paper_name', 13, '', 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'paper_num', 14, '', 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'zzbh', 15, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'khhh', 16, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'khzh', 17, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'reg_date', 18, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'last_date', 19, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'times', 20, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_user', 'action', 21, 'y', 'NO', 'enum', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''y'',''n'')', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_vote', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_vote', 'caption', 2, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_vote', 'thing', 3, '', 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_vote', 'data', 4, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'b2c_vote', 'date', 5, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'code', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'annee', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'mois', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'vpm', 4, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'topVis', 5, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'topNavOS', 6, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'topOS', 7, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'topNav', 8, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'vph', 9, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'topRef', 10, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'topDom', 11, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_archives', 'vpj', 12, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_counter', 'num', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_counter', 'today', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_counter', 'time', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_domaines', 'code', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'co_domaines', 'domaine', 2, '', 'NO', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_domaines', 'description', 3, '', 'NO', 'char', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(50)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_useronline', 'zeit', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(15)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_useronline', 'ip', 2, '', 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'AGENT', 1, NULL, 'YES', 'char', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'REFERER', 2, NULL, 'YES', 'char', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(200)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'ADDR', 3, '', 'NO', 'char', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(50)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'DATE', 4, NULL, 'YES', 'char', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(20)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'HOST', 5, NULL, 'YES', 'char', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'CODE', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'co_visiteurs', 'REF_HOST', 7, NULL, 'YES', 'char', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'activity_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'creator_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'type', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
('def', 'test', 'activities', 'receiver_id', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'object1', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'object2', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'school_id', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activities', 'activity_date', 8, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activitytype', 'type_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'activitytype', 'name', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'activitytype', 'statement', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'comments', 'c_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'comments', 'school_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'comments', 'content', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'popularity', 'object_type', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', '1 for chat page, 2 for profile page, 3 for totem'),
('def', 'test', 'popularity', 'object_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', 'shcool id or user id or totem id'),
('def', 'test', 'popularity', 'class_year', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', 'class year'),
('def', 'test', 'popularity', 'school_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', 'user''s school id '),
('def', 'test', 'popularity', 'num', 5, '1', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', 'number of click times'),
('def', 'test', 'schools', 'school_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'schools', 'name', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'schools', 'city', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'schools', 'state_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'schools', 'state', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'schools', 'zip', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'user_has_activity', 'user_user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'test', 'user_has_activity', 'activity_activity_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'test', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'users', 'email', 2, '', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'test', 'users', 'password', 3, '', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users', 'userID', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'first_name', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'last_name', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'school_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'school_year', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'class_year', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'phone_num', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'pager_num', 8, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'facebook', 9, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'linkedin', 10, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'twitter', 11, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'google', 12, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'location', 13, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'ip_address', 14, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'roommates', 15, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'hospital', 16, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'usertype', 17, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'date_created', 18, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'last_login_date', 19, NULL, 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'last_visit_date', 20, NULL, 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'sponsor_num', 21, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'status', 22, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'altemail', 23, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'summary', 24, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'interests', 25, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'favstuspot', 26, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'favdrink', 27, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'pet', 28, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'users_info', 'petpeeve', 29, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'testdb', 'users', 'username', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'testdb', 'users', 'fname', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'testdb', 'users', 'lname', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'albums', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'zftest', 'albums', 'artist', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'albums', 'title', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'zftest', 'users', 'username', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'users', 'password', 3, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'users', 'salt', 4, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'users', 'role', 5, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'zftest', 'users', 'date_created', 6, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', '');
...
('ABORTED_CLIENTS', '0'),
('ABORTED_CONNECTS', '248'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '0'),
('BYTES_RECEIVED', '1744770'),
('BYTES_SENT', '13884172'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '1419'),
('CREATED_TMP_DISK_TABLES', '1846'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '2100'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '0'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '16871'),
('HANDLER_DELETE', '27'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '12294'),
('HANDLER_READ_KEY', '17568'),
('HANDLER_READ_LAST', '12'),
('HANDLER_READ_NEXT', '6519'),
('HANDLER_READ_PREV', '64'),
('HANDLER_READ_RND', '386'),
('HANDLER_READ_RND_NEXT', '186999'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '27'),
('HANDLER_WRITE', '19863'),
('INNODB_BUFFER_POOL_PAGES_DATA', '244'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '688'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7947'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '98549'),
('INNODB_BUFFER_POOL_READS', '167'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1669'),
('INNODB_DATA_FSYNCS', '403'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '4919296'),
('INNODB_DATA_READS', '177'),
('INNODB_DATA_WRITES', '665'),
('INNODB_DATA_WRITTEN', '11499008'),
('INNODB_DBLWR_PAGES_WRITTEN', '344'),
('INNODB_DBLWR_WRITES', '83'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '251'),
('INNODB_LOG_WRITES', '155'),
('INNODB_OS_LOG_FSYNCS', '237'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '184832'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '78'),
('INNODB_PAGES_READ', '166'),
('INNODB_PAGES_WRITTEN', '344'),
...
('INNODB_ROWS_INSERTED', '125'),
('INNODB_ROWS_READ', '136402'),
('INNODB_ROWS_UPDATED', '5'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '6693'),
('KEY_BLOCKS_USED', '5'),
('KEY_READ_REQUESTS', '2969'),
('KEY_READS', '5'),
...
('THREADS_CACHED', '0'),
('THREADS_CONNECTED', '1'),
('THREADS_CREATED', '1418'),
('THREADS_RUNNING', '1'),
('UPTIME', '103058'),
('UPTIME_SINCE_FLUSH_STATUS', '103058');
...
('FLUSH_TIME', '0'),
('GENERAL_LOG_FILE', '/var/lib/mysql/ip-10-160-118-192.log'),
...
('HAVE_CSV', 'YES'),
('OLD_ALTER_TABLE', 'OFF'),
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/ip-10-160-118-192-slow.log'),
...
('def', 'board', 'PRIMARY', 'def', 'board', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'shop', 'PRIMARY', 'def', 'shop', 'b2c_ad', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'b2c_link', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'b2c_vote', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'co_archives', 'code', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'co_domaines', 'code', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'co_useronline', 'zeit', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'co_visiteurs', 'CODE', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'activities', 'activity_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'activitytype', 'type_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'comments', 'c_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'popularity', 'object_type', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'popularity', 'object_id', 2, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'popularity', 'class_year', 3, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'popularity', 'school_id', 4, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'schools', 'school_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'user_has_activity', 'user_user_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'user_has_activity', 'activity_activity_id', 2, NULL, NULL, NULL, NULL),
('def', 'test', 'fk_user_has_activity_activity1', 'def', 'test', 'user_has_activity', 'activity_activity_id', 1, 1, 'test', 'activities', 'activity_id'),
('def', 'test', 'fk_user_has_activity_user1', 'def', 'test', 'user_has_activity', 'user_user_id', 1, 1, 'test', 'users_info', 'user_id'),
('def', 'test', 'PRIMARY', 'def', 'test', 'users', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'email', 'def', 'test', 'users', 'email', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'userID', 'def', 'test', 'users', 'userID', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'users_info', 'user_id', 1, NULL, NULL, NULL, NULL),
('def', 'zftest', 'PRIMARY', 'def', 'zftest', 'albums', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'zftest', 'PRIMARY', 'def', 'zftest', 'users', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2012-06-21 04:23:33', NULL, NULL, NULL, '', '', NULL),
('def', 'board', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 8388608, '2012-06-20 06:45:40', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 880, 123848989752688639, 5120, 880, '2012-06-06 19:56:13', '2012-06-06 19:57:48', '2012-06-06 19:56:13', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1028, 9, 9252, 2533274790395903, 19456, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 868, 441428, 281474976710655, 20480, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 693, 1386, 195062158860484607, 5120, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 105, 540, 281474976710655, 2048, 224, '2012-06-06 19:56:13', '2012-06-06 19:57:43', NULL, NULL, '', '', NULL),
...
('def', 'shop', 'b2c_ad', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_class', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 22, 128, 281474976710655, 2048, 40, '2012-06-19 23:23:09', '2012-06-20 03:58:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_goods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, 164, 3708, 281474976710655, 2048, 80, '2012-06-19 23:23:09', '2012-06-20 06:14:36', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_link', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_news', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_requests', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 142, 1280, 281474976710655, 2048, 284, '2012-06-19 23:23:09', '2012-06-20 06:26:26', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_shopping', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 55, 28, 1764, 7881299347898367, 2048, 224, '2012-06-19 23:23:09', '2012-06-20 06:23:56', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 121, 624, 281474976710655, 2048, 140, '2012-06-19 23:23:09', '2012-06-21 03:30:03', NULL, NULL, '', '', NULL),
('def', 'shop', 'b2c_vote', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'co_archives', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'co_counter', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'co_domaines', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 21110623253299199, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'co_useronline', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'shop', 'co_visiteurs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 161848111608627199, 1024, 0, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, NULL, '', '', NULL),
('def', 'test', 'activities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 33, 496, 16384, NULL, 0, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'activitytype', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 27, 606, 16384, NULL, 0, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'comments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'popularity', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'schools', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 1489, 16384, NULL, 0, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'user_has_activity', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 32768, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'users_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 0, 8388608, '2012-06-20 07:13:37', NULL, NULL, NULL, '', '', NULL),
('def', 'testdb', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 9437184, '2012-06-06 20:18:53', NULL, NULL, NULL, '', '', NULL),
('def', 'zftest', 'albums', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 9437184, '2012-06-07 16:54:27', NULL, NULL, NULL, '', '', NULL),
('def', 'zftest', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 9437184, '2012-06-07 21:30:49', NULL, NULL, NULL, '', '', NULL);
...
(1418, 'root', 'localhost', 'board', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'test', 'fk_user_has_activity_activity1', 'def', 'test', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'user_has_activity', 'activities'),
('def', 'test', 'fk_user_has_activity_user1', 'def', 'test', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'user_has_activity', 'users_info');
...
('def', 'board', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'shop', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'testdb', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'zftest', 'utf8', 'utf8_general_ci', NULL);
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '98885'),
('INNODB_BUFFER_POOL_READS', '167'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1669'),
('INNODB_DATA_FSYNCS', '403'),
...
('def', 'board', 'users', 0, 'board', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'user', 0, 'mysql', 'PRIMARY', 2, 'User', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_ad', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_class', 1, 'shop', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_goods', 1, 'shop', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_link', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_news', 1, 'shop', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_requests', 1, 'shop', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_shopping', 1, 'shop', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_user', 1, 'shop', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'b2c_vote', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_archives', 0, 'shop', 'PRIMARY', 1, 'code', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_archives', 1, 'shop', 'annee', 1, 'annee', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_archives', 1, 'shop', 'mois', 1, 'mois', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_domaines', 0, 'shop', 'PRIMARY', 1, 'code', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_useronline', 0, 'shop', 'PRIMARY', 1, 'zeit', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_useronline', 1, 'shop', 'ip', 1, 'ip', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_visiteurs', 0, 'shop', 'PRIMARY', 1, 'CODE', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'co_visiteurs', 1, 'shop', 'ADDR', 1, 'ADDR', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'activities', 0, 'test', 'PRIMARY', 1, 'activity_id', 'A', 33, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'activitytype', 0, 'test', 'PRIMARY', 1, 'type_id', 'A', 27, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'comments', 0, 'test', 'PRIMARY', 1, 'c_id', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'popularity', 0, 'test', 'PRIMARY', 1, 'object_type', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'popularity', 0, 'test', 'PRIMARY', 2, 'object_id', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'popularity', 0, 'test', 'PRIMARY', 3, 'class_year', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'popularity', 0, 'test', 'PRIMARY', 4, 'school_id', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'schools', 0, 'test', 'PRIMARY', 1, 'school_id', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'user_has_activity', 0, 'test', 'PRIMARY', 1, 'user_user_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'user_has_activity', 0, 'test', 'PRIMARY', 2, 'activity_activity_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'user_has_activity', 1, 'test', 'fk_user_has_activity_activity1', 1, 'activity_activity_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'user_has_activity', 1, 'test', 'fk_user_has_activity_user1', 1, 'user_user_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'users', 0, 'test', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'users', 0, 'test', 'email', 1, 'email', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'users', 0, 'test', 'userID', 1, 'userID', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'users_info', 0, 'test', 'PRIMARY', 1, 'user_id', 'A', 10, NULL, NULL, '', 'BTREE', '', ''),
('def', 'zftest', 'albums', 0, 'zftest', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'zftest', 'users', 0, 'zftest', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-21 04:23:33', '2012-06-21 04:23:33', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2012-06-21 04:23:33', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'board', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 8388608, 7, '2012-06-20 06:45:40', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 880, 123848989752688639, 5120, 880, NULL, '2012-06-06 19:56:13', '2012-06-06 19:57:48', '2012-06-06 19:56:13', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1028, 9, 9252, 2533274790395903, 19456, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 868, 441428, 281474976710655, 20480, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 693, 1386, 195062158860484607, 5120, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', '2012-06-06 19:56:13', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-06-06 19:56:13', '2012-06-06 19:56:13', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 105, 540, 281474976710655, 2048, 224, NULL, '2012-06-06 19:56:13', '2012-06-06 19:57:43', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'shop', 'b2c_ad', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_class', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 22, 128, 281474976710655, 2048, 40, 9, '2012-06-19 23:23:09', '2012-06-20 03:58:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_goods', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 22, 164, 3708, 281474976710655, 2048, 80, 28, '2012-06-19 23:23:09', '2012-06-20 06:14:36', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_link', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_news', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_requests', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 142, 1280, 281474976710655, 2048, 284, 15, '2012-06-19 23:23:09', '2012-06-20 06:26:26', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_shopping', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 55, 28, 1764, 7881299347898367, 2048, 224, 93, '2012-06-19 23:23:09', '2012-06-20 06:23:56', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 121, 624, 281474976710655, 2048, 140, 7, '2012-06-19 23:23:09', '2012-06-21 03:30:03', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'b2c_vote', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'co_archives', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'co_counter', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'co_domaines', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 21110623253299199, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'co_useronline', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'shop', 'co_visiteurs', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 161848111608627199, 1024, 0, 1, '2012-06-19 23:23:09', '2012-06-19 23:23:09', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'activities', 'BASE TABLE', 'InnoDB', 10, 'Compact', 33, 496, 16384, 0, 0, 8388608, 37, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'activitytype', 'BASE TABLE', 'InnoDB', 10, 'Compact', 27, 606, 16384, 0, 0, 8388608, 28, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'comments', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 8388608, 21, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'popularity', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 8388608, NULL, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'schools', 'BASE TABLE', 'InnoDB', 10, 'Compact', 11, 1489, 16384, 0, 0, 8388608, 13, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'user_has_activity', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 8388608, NULL, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 32768, 8388608, 5, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'users_info', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 0, 8388608, 1032, '2012-06-20 07:13:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'testdb', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 8388608, NULL, '2012-06-06 20:18:53', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'zftest', 'albums', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 8388608, 11, '2012-06-07 16:54:27', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'zftest', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, 2, '2012-06-07 21:30:49', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'board', 'PRIMARY', 'board', 'users', 'PRIMARY KEY'),
...
('def', 'shop', 'PRIMARY', 'shop', 'b2c_ad', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'b2c_link', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'b2c_vote', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'co_archives', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'co_domaines', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'co_useronline', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'co_visiteurs', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'activities', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'activitytype', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'comments', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'popularity', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'schools', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'user_has_activity', 'PRIMARY KEY'),
('def', 'test', 'fk_user_has_activity_activity1', 'test', 'user_has_activity', 'FOREIGN KEY'),
('def', 'test', 'fk_user_has_activity_user1', 'test', 'user_has_activity', 'FOREIGN KEY'),
('def', 'test', 'PRIMARY', 'test', 'users', 'PRIMARY KEY'),
('def', 'test', 'email', 'test', 'users', 'UNIQUE'),
('def', 'test', 'userID', 'test', 'users', 'UNIQUE'),
('def', 'test', 'PRIMARY', 'test', 'users_info', 'PRIMARY KEY'),
('def', 'zftest', 'PRIMARY', 'zftest', 'albums', 'PRIMARY KEY'),
('def', 'zftest', 'PRIMARY', 'zftest', 'users', 'PRIMARY KEY');
...
('localhost', 'root', '', '', 1, '', '2012-06-06 19:56:13'),
('ip-10-161-22-111', 'root', '', '', 1, '', '2012-06-06 19:56:13');
...
('localhost', 'root', '*1F0B6D220BD155632AE39F5E2BB9B58647A106F2', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
('127.0.0.1', 'root', '*1F0B6D220BD155632AE39F5E2BB9B58647A106F2', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
('::1', 'root', '*1F0B6D220BD155632AE39F5E2BB9B58647A106F2', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', '');
--
...
(1, 1, 'Amana 25 -Cubic Foot Side-by-Side Refrigerator, ASD2522WRS,', 'Amana 25 -Cubic Foot Side-by-Side Refrigerator, ASD2522WRS, Stainless Steel', 'goods_img/1340044298.jpg', 1200, 1100, 0, '2012-06-14 00:00:00'),
(2, 1, 'Bosch Evolution 500 Series : HGS5053UC 30 Freestanding Gas R', 'Bosch Evolution 500 Series : HGS5053UC 30 Freestanding Gas Range with 5 Sealed Burners - Stainless', 'goods_img/1340044347.jpg', 1000, 980, 0, '2012-06-14 00:00:00'),
(3, 1, 'Amana 3.4 cu. ft. Top-Load Washer with Sprekle Porcelain was', 'Amana 3.4 cu. ft. Top-Load Washer with Sprekle Porcelain wash basket, NTW4600YQ, White', 'goods_img/1340044375.jpg', 550, 525, 0, '2012-06-18 00:00:00'),
(4, 1, 'EVGA GeForce GTX 550 Ti FPB 1024 MB GDDR5 PCI Express 2.0 2D', 'EVGA GeForce GTX 550 Ti FPB 1024 MB GDDR5 PCI Express 2.0 2DVI/Mini-HDMI SLI Ready Graphics Card, 01G-P3-1556-KR', 'goods_img/1340044407.jpg', 130, 110, 0, '2012-06-14 00:00:00'),
(27, 2, 'strawberry', 'strawberry', 'goods_img/1340172876.jpg', 3, 2, 0, '0000-00-00 00:00:00'),
(6, 1, 'iHome iA9BZC App-Enhanced Dual Alarm Clock Radio for iPhone/', 'iHome iA9BZC App-Enhanced Dual Alarm Clock Radio for iPhone/iPod with AM/FM presets (Black)', 'goods_img/1340044483.jpg', 80, 70, 0, '2012-06-18 00:00:00'),
(7, 1, 'Canon PIXMA MG5220 Wireless Inkjet Photo All-in-One (4502B01', 'Canon PIXMA MG5220 Wireless Inkjet Photo All-in-One (4502B017)', 'goods_img/1340044519.jpg', 110, 99, 0, '2012-06-18 00:00:00'),
(8, 1, 'Epiphone LP Special II Les Paul Electric Guitar, Vintage Sun', 'Epiphone LP Special II Les Paul Electric Guitar, Vintage Sunburst', 'goods_img/1340044548.jpg', 150, 130, 0, '2012-06-18 00:00:00'),
(11, 3, 'Shany Carry All Trunk Professional 48 pc. Makeup Kit, Gift S', 'Shany Carry All Trunk Professional 48 pc. Makeup Kit, Gift Set', 'goods_img/1340045099.jpg', 28, 25, 0, '2012-06-14 00:00:00'),
(12, 3, 'Shany 2012 Edition All In One Harmony Makeup Kit, 25 Ounce', 'Shany 2012 Edition All In One Harmony Makeup Kit, 25 Ounce', 'goods_img/1340045131.jpg', 40, 35, 0, '2012-06-14 00:00:00'),
(13, 3, 'Shany Cosmetics Carry All Train Case with Makeup and Reusabl', 'Shany Cosmetics Carry All Train Case with Makeup and Reusable Aluminium Case', 'goods_img/1340045182.jpg', 20, 15, 0, '2012-06-18 00:00:00'),
(14, 3, 'Kingsley Travel Cosmetic Bag Clear Vinyl Dopp Kit', 'Kingsley Travel Cosmetic Bag Clear Vinyl Dopp Kit', 'goods_img/1340045225.jpg', 10, 7, 0, '2012-06-18 00:00:00'),
(15, 3, 'BH Cosmetics 120 Color Eyeshadow Palette 2nd Edition', 'BH Cosmetics 120 Color Eyeshadow Palette 2nd Edition', 'goods_img/1340045268.jpg', 20, 18, 0, '2012-06-18 00:00:00'),
(16, 2, 'apple', 'apple', 'goods_img/1340045320.jpg', 2, 1, 0, '2012-06-18 00:00:00'),
(17, 2, 'banana', 'banana', 'goods_img/1340045393.jpg', 3, 2, 0, '2012-06-14 00:00:00'),
(18, 2, 'Key_lime_pie', 'Key_lime_pie', 'goods_img/1340045436.jpg', 5, 3, 0, '2012-06-18 00:00:00'),
(19, 2, 'sandwich', 'sandwich', 'goods_img/1340045504.jpg', 5, 4, 0, '2012-04-13 00:00:00'),
(20, 5, 'Shadow of Night: A Novel [Hardcover]', 'Shadow of Night: A Novel [Hardcover]', 'goods_img/1340045746.jpg', 17, 15, 0, '2012-06-02 00:00:00'),
(21, 5, 'Wicked Business: A Lizzy and Diesel Novel [Hardcover]', 'Wicked Business: A Lizzy and Diesel Novel [Hardcover]', 'goods_img/1340045802.jpg', 16, 14, 0, '2012-06-18 00:00:00'),
(22, 5, 'Introduction-to-Probability-By-Grinstead', 'Introduction-to-Probability-By-Grinstead', 'goods_img/1340045859.jpg', 45, 40, 0, '2012-06-18 00:00:00'),
(23, 5, 'Fifty Shades of Grey: Book One of the Fifty Shades Trilogy', 'Fifty Shades of Grey: Book One of the Fifty Shades Trilogy', 'goods_img/1340045921.jpg', 9, 8, 0, '2012-05-13 00:00:00'),
(26, 2, 'Grape', 'Grape', 'goods_img/1340172503.jpg', 5, 4, 0, '2012-06-18 00:00:00');
...
(13, 1, 'Zhi Ma', 1, 'nldfr219@gmail.com', 'CA', 'Los Angeles', '2133002063', '2831 Ellendale Pl.', '90007', NULL, 45.00, 0, 0, 0, '2012-06-19 19:14:47', '5389556737840293', 'Zhi Ma', '03-2017', 0),
(14, 1, 'Zhi Ma', 1, 'nldfr219@gmail.com', 'CA', 'Los Angeles', '2133002063', '2831 Ellendale Pl.', '90007', NULL, 45.00, 0, 0, 0, '2012-06-19 19:18:10', '5389556737840293', 'Zhi Ma', '03-2017', 1);
...
(85, 13, 1, 18, 2, '2012-06-19 19:14:47'),
(86, 13, 1, 20, 1, '2012-06-19 19:14:47'),
(87, 13, 1, 23, 2, '2012-06-19 19:14:47'),
(88, 13, 1, 19, 2, '2012-06-19 19:14:47'),
(89, 14, 1, 18, 2, '2012-06-19 19:18:10'),
(90, 14, 1, 20, 1, '2012-06-19 19:18:10'),
(91, 14, 1, 23, 2, '2012-06-19 19:18:10'),
(92, 14, 1, 19, 2, '2012-06-19 19:18:10');
...
(1, 'nldfr219', '123456', 'Zhi Ma', 1, 'nldfr219@gmail.com', 'CA', 'Los Angeles', '2133002063', '2831 Ellendale Pl.', '90007', NULL, '', '', NULL, NULL, NULL, '2012-06-18', '2012-06-20 20:30:03', 22, 'y'),
...
(14, 1029, 1, 7, NULL, NULL, 7, '2012-06-16 20:57:46'),
(15, 1029, 29, 7, 1, NULL, 7, '2012-06-18 16:57:51'),
(16, 1029, 29, 7, 2, NULL, 7, '2012-06-18 16:58:06'),
(17, 1030, 1, 2, NULL, NULL, 2, '2012-06-18 17:07:47'),
(18, 1030, 29, 2, 3, NULL, 2, '2012-06-18 17:07:54'),
(19, 1029, 29, 7, 4, NULL, 7, '2012-06-20 22:06:05'),
(20, 1029, 29, 7, 5, NULL, 7, '2012-06-20 22:06:08'),
(21, 1029, 29, 7, 6, NULL, 7, '2012-06-20 22:06:10'),
(22, 1029, 29, 7, 7, NULL, 7, '2012-06-20 22:06:19'),
(23, 1029, 29, 7, 8, NULL, 7, '2012-06-20 22:06:53'),
(24, 1029, 29, 7, 9, NULL, 7, '2012-06-20 22:09:25'),
(25, 1029, 29, 7, 10, NULL, 7, '2012-06-20 22:45:46'),
(26, 1029, 29, 7, 11, NULL, 7, '2012-06-20 22:46:17'),
(27, 1029, 29, 7, 12, NULL, 7, '2012-06-20 22:51:23'),
(28, 1029, 29, 7, 13, NULL, 7, '2012-06-20 23:01:24'),
(29, 1029, 29, 7, 14, NULL, 7, '2012-06-20 23:02:00'),
(30, 1029, 29, 7, 15, NULL, 7, '2012-06-20 23:22:51'),
(31, 1029, 29, 7, 16, NULL, 7, '2012-06-20 23:23:06'),
(32, 1029, 29, 7, 17, NULL, 7, '2012-06-20 23:34:27'),
(33, 1029, 29, 7, 18, NULL, 7, '2012-06-20 23:34:45'),
(34, 1031, 1, 7, NULL, NULL, 7, '2012-06-21 02:18:25'),
(35, 1029, 29, 7, 19, NULL, 7, '2012-06-21 02:19:32'),
(36, 1029, 29, 7, 20, NULL, 7, '2012-06-21 03:19:04');
...
INSERT INTO `comments` (`c_id`, `school_id`, `content`) VALUES
(1, 7, 'dsfsfs'),
(2, 7, 'how you doing'),
(3, 2, 'dsfdsf'),
(4, 7, '123'),
...
(2, 'nldfr219@gmail.com', '123456789', 1029),
(3, 'zizuoliu@gmail.com', '123456789', 1030),
(4, 'sailuo@gmail.com', '123456789', 1031);
...
CREATE TABLE IF NOT EXISTS `users_info` (
  ...
  `favstuspot` varchar(200) NOT NULL,
  `favdrink` varchar(100) NOT NULL,
  `pet` varchar(50) NOT NULL,
  `petpeeve` varchar(100) NOT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `users_info` (`user_id`, `first_name`, `last_name`, `school_id`, `school_year`, `class_year`, `phone_num`, `pager_num`, `facebook`, `linkedin`, `twitter`, `google`, `location`, `ip_address`, `roommates`, `hospital`, `usertype`, `date_created`, `last_login_date`, `last_visit_date`, `sponsor_num`, `status`, `altemail`, `summary`, `interests`, `favstuspot`, `favdrink`, `pet`, `petpeeve`) VALUES
...
(1029, 'Zhi', 'Ma', 7, 2011, 4, 2132003020, 0, 'www.facebook.com', 'www.linkedin.com', 'www.twitter.com', NULL, '24052 Silverbay Dr., Lake Forest, CA, 92630', NULL, NULL, NULL, 0, '2012-06-16 20:57:46', NULL, NULL, 0, 'Not currently involved, but looking', 'zhima@usc.edu', 'As recent graduate from Durham University, with a 2:1 honours degree in media communications, I have undertaken several internships within leading organisations such as Bertelsmann and Times Warner. These placements have enabled me to develop not only specific media industry experience, but also a valuable and transferable skill set in this fast-paced sector.', 'Making new friends', 'Coffee Bean and Tea Life at The Harbor, MedEd Basement from 8pm to midnight', 'Americano with extra sugar and cream', 'I have a pitbull', 'I don''t like people who sneer at me when I ask questions'),
(1030, 'Zizuo', 'Liu', 2, 2008, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2012-06-18 17:07:46', NULL, NULL, 0, '1', '', '', '', '', '', '', ''),
(1031, 'Sai', 'Luo', 7, 2010, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2012-06-21 02:18:25', NULL, NULL, 0, '1', '', '', '', '', '', '', '');
...
('sdfsf', 'fddsfd', 'dfsdf'),
('sdfdsfds', 'dfdsf', 'dfsfddfsd'),
('dfdsf', 'sfdsfsf', 'sfdsfsd'),
('dfsfd', 'sfdsfsfsdf', 'dsfdsfsdf');
--
-- 数据库: `zftest`
--
CREATE DATABASE `zftest` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `zftest`;
...
(1, 'admin', 'cb3aefbdffbc81588f3d43c394428b16d4346b44', 'ce8d96d579d389e783f95b3772785783ea1a9854', 'administrator', '2012-06-07 21:31:40');
