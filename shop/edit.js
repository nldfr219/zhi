...
{
if (!	validateMode())	return;
var arr = showModalDialog("img_upload.htm", "", "dialogWidth:40.08em; dialogHeight:15.83em; status:0");
...
"2.使用上传图片功能，系统将自动帮您上传图片文件到服务器目录\r\n\r\n"+
"3.可以用直接选中所要编辑的符号用工具栏对应的按钮编辑\r\n\r\n"+
"4.直接上传图片并可马上看见图片的效果\r\n\r\n"+
"5.如果粘贴WORD的内容，请使用'从word中粘贴'按钮";
alert(helpmess);

}

//**********************************************
//* 功能：从word中粘贴，同时，去掉word的无用代码
//* 来源：
//* 参数(输入)：
//* 输出：
//* 时间：2004-7-16
//* 作者：紫文科技 www.zwon.net 王友兴 （网名：海风习习 
//* QQ：10196648 wyx726@126.com ）
//**********************************************
function PasteWord()
{
	Composition.document.execCommand("Paste",false);
	var editBody=Composition.document.body;
	...
	var html=Composition.document.body.innerHTML;
