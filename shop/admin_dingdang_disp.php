...
<table width="749" border="0" cellspacing="1" align="center">
  <tr bgcolor="#EFEFEF" align="center"> 
    <td> <br>
      ...
      <?php
$db->query("select * from $shopping_t where requests_id=($id-$init_num)");
if ($db->num_rows())
{
?>
      <br>
...
?>
      ...
      <table align=center border=0 cellspacing=0 width="86%">
        ...
        <tr> 
          ...
          <td height=28 width="16%"><font color=#cc0000>Fee:</font> </td>
 ...
 echo "<br><br>Sorry, the order does not exist!<br><br>";
?>
      <br>
    </td>
  </tr>
