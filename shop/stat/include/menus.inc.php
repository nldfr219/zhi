...
// ------------------------------------------------------------------------- //
    ...
    echo '<TR>';
      if ($view != VIEW_ADMIN) echo '<TH CLASS="vis">&nbsp;<B>'.${"lvm_title_".$view}.'</B>&nbsp;</TH>';
      echo '<TD CLASS="fond" WIDTH="0">&nbsp;</TD>';
      echo '<TH CLASS="vis">&nbsp;<B>'.$lvm_title_others.'</B>&nbsp;</TH>';
      echo '<TH CLASS="vis">&nbsp;<B>'.str_replace('{NB_LAST_MONTHS}', $lvc_nb_last_months, $lvm_title_last_months).'</B>&nbsp;</TH>';
    ...
    echo '<TR>';
      ...
      if ($view != VIEW_ADMIN)
      {
          echo '<TD CLASS="vis" NOWRAP VALIGN="top">';
